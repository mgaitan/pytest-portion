# -*- coding: utf-8 -*-
#
# pytest-portion documentation build configuration file, created by
...
def get_version() -> str:
    try:
        return metadata.version("pytest-portion")
    except (
        metadata.PackageNotFoundError
    ):  # pragma: no cover - resolved at runtime when installed
        return "unknown"
